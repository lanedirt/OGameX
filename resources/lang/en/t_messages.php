...
Metal: :metal Crystal: :crystal Deuterium: :deuterium',
    ...
    // ------------------------
    'espionage' => [
        'defender_warning_subject' => 'Espionage report from Planet :planet',
        'defender_warning_body'    => "A foreign fleet from planet :planet (:attacker_name) was sighted near your planet\n:defender\nChance of counter-espionage: :chance%",
        'defender_warning_from'    => 'Fleet Command',
    ],
