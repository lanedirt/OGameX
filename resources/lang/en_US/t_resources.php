...
return [
    ...
    'deuterium_synthesizer' => [
        ...
        'description' => 'Deuterium is used as fuel for spaceships and is harvested in the deep sea. Deuterium is a rare substance and is thus relatively expensive.',
...
In order to function, each colony must be able to conduct the research independently.',
    ...
    'armor_technology' => [
        'title' => 'Armor Technology',
        'description' => 'Special alloys improve the armor on ships and defensive structures. The effectiveness of the armor can be increased by 10 % per level.',
