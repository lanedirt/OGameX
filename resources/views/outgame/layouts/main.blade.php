...
<div id="footer">
    ...
    .lang-flag { 
        ...
        flex-shrink: 0;
        box-sizing: border-box; /* Stops the browser adding invisible pixels to the box */
        width: 16px;
        min-width: 16px;
        height: 11px;
        margin-right: 6px;
        ...
        background-size: 100% 100%; /* Not "cover": force the image to exactly 16x11 pixels */
    ...
    /* IT, NL and DE are exact gradients rather than images */
    .lang-flag-it { 
