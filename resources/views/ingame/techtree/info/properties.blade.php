            ...
            <tr class="structural_integrity">
                ...
                <td>
                    <span class="tooltipHTML tipped advice"
                        ...
                        {{ \OGame\Facades\AppUtil::formatNumber($properties->structuralIntegrity->totalValue) }}
                    </span>
                </td>
            </tr>
        @endif
            ...
            <tr class="shield_strength">
                ...
                <td>
                    <span class="tooltipHTML tipped advice" title="{{ $tooltips['shield'] }}"
                        ...
                        {{ \OGame\Facades\AppUtil::formatNumber($properties->shield->totalValue) }}
                    </span>
                </td>
            </tr>
        @endif
            ...
            <tr class="attack_strength">
                ...
                <td>
                    <span class="tooltipHTML tipped advice" title="{{ $tooltips['attack'] }}"
                        ...
                        {{ \OGame\Facades\AppUtil::formatNumber($properties->attack->totalValue) }}
                    </span>
                </td>
            </tr>
        @endif
            ...
            <tr class="speed">
                ...
                <td>
                    <span class="tooltipHTML tipped advice" title="{{ $tooltips['speed'] }}"
                        ...
                        {{ \OGame\Facades\AppUtil::formatNumber($properties->speed->totalValue) }}
                    </span>
                </td>
            </tr>
        @endif
            ...
            <tr class="cargo_capacity">
                ...
                <td>
                    <span class="tooltipHTML tipped advice" title="{{ $tooltips['shield'] }}"
                        ...
                        {{ \OGame\Facades\AppUtil::formatNumber($properties->capacity->totalValue) }}
                    </span>
                </td>
            </tr>
        @endif
            ...
            <tr class="fuel_consumption">
                ...
                <td>
                    <span class="tooltipHTML tipped advice" title="{{ $tooltips['fuel'] }}"
                        ...
                        {{ \OGame\Facades\AppUtil::formatNumber($properties->fuel->totalValue) }}
                    </span>
                </td>
            </tr>
        @endif
