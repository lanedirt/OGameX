@if (!empty($properties))
    <table class="combat_unit_details">
        <thead>
        <tr>
            <th colspan="2">{{ __('t_ingame.techtree.properties_technical_data') }}</th>
        </tr>
        </thead>
        <tbody>
        @if (isset($properties['structural_integrity']))
            <tr class="structural_integrity">
                <th>{{ __('t_ingame.techtree.properties_structural_integrity') }}</th>
                <td>
        ...
        @if (isset($properties['shield']))
            <tr class="shield_strength">
                <th>{{ __('t_ingame.techtree.properties_shield_strength') }}</th>
                <td>
        ...
        @if (isset($properties['attack']))
            <tr class="attack_strength">
                <th>{{ __('t_ingame.techtree.properties_attack_strength') }}</th>
                <td>
        ...
        @if (isset($properties['speed']))
            <tr class="speed">
                <th>{{ __('t_ingame.techtree.properties_speed') }}</th>
                <td>
        ...
        @if (isset($properties['capacity']))
            <tr class="cargo_capacity">
                <th>{{ __('t_ingame.techtree.properties_cargo_capacity') }}</th>
                <td>
        ...
        @if (isset($properties['fuel']))
            <tr class="fuel_consumption">
                <th>{{ __('t_ingame.techtree.properties_fuel_usage') }}</th>
                <td>
