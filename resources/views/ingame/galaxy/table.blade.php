                ...
                <table cellpadding="0" cellspacing="0" id="galaxytable" border="0" data-galaxy="{{ $current_galaxy }}" data-system="{{ $current_system }}">
                    <thead>
                    ...
                    <tr class="row empty_filter
                        ...
                        <td colspan="1" class="microplanet @if ($row['planet']) colonized @else planetEmpty js_planetEmpty1 @endif js_planet1">
                            @if ($row['planet'])
                            <div class="ListImage">
                                <a href="javascript: void(0);" onclick="sendShips(
                                    ...
                                    <img class="planetTooltip {{ $row['planet']->getPlanetType() }}_{{ $row['planet']->getPlanetImageType() }}" src="/img/icons/3e567d6f16d040326c7a0ea29a4f41.gif" alt="" height="33" width="38">
                                </a>

                            </div>
                            @endif
                            <div id="ownFleetStatus_1_1" class="fleetAction">
                                <img src="/img/icons/3e567d6f16d040326c7a0ea29a4f41.gif" width="12" height="12" alt="">
                            </div>
                        </td>
                        ...
                        <td class="playername
                               js_playerName1
                               js_no_action                                                               ">
                                @if ($row['planet'])<span class="status_abbr_active">{{ $row['planet']->getPlayer()->getUsername() }}</span>@endif
                                                    <span class="status">
                                                        </span>
                        </td>
                        <td class="allytag
                        ...
                        @if ($row['planet'])
                                <span>
                                                                                                                                                                                                                                                            <a class="tooltip js_hideTipOnMobile espionage" title="" href="javascript: void(0);" onclick="sendShips(
                                                           6,
                                                           4,
                                                           198,
                                                           4,
                                                        ...
                                                        <span class="icon icon_eye"></span>
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                <a href="javascript:void(0)" class="sendMail js_openChat tooltip" data-playerid="109997" title="Write message"><span class="icon icon_chat"></span></a>
                                                                                                                                                                                                                                                    <a class="tooltip overlay buddyrequest" title="Buddy request" href="{{ route('buddies.index', ['action' => 7, 'id' => 109997, 'ajax' => 1]) }}" data-overlay-title="Buddy request to player">
