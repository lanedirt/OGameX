...
@section('content')
    ...
    <div id="researchcomponent" class="maincontent">
        ...
        <script type="text/javascript">
            ...
            var lastBuildingSlot = {"showWarning":false,"exemptTechnologyIds":[33,41],"shouldWarnForTechnologyId":function(technologyId){return this.showWarning&&this.exemptTechnologyIds.indexOf(Number(technologyId))===-1;},"slotWarning":"This building will use the last available building slot. Expand your Terraformer or buy a Planet Field item (e.g. <a href=\"#page&#61;shop#page&#61;shop&amp;category&#61;c18170d3125b9941ef3a86bd28dded7bf2066a6a&amp;item&#61;04e58444d6d0beb57b3e998edc34c60f8318825a\" class=\"tooltipHTML itemLink\">Gold Planet Fields<\/a>) to obtain more slots. Are you sure you want to build this building?"};
        </script>
    </div>
