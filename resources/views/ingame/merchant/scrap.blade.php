        ...
        <div id="inhalt">
            <div id="planet" style="background-position: 0px -220px; height: 250px;" class="detail">
                ...
                <div id="header_text" style="display: block;">
                    <h2>@lang('t_merchant.scrap_merchant')</h2>
                    <a class="back_to_overview js_backToOverview tooltip js_hideTipOnMobile right" href="{{ route('merchant.index') }}" data-tooltip-title="@lang('t_merchant.back')" style="display: inline;"></a>
                    <a class="small_back_to_overview js_backToOverview tooltip js_hideTipOnMobile" href="{{ route('merchant.index') }}" data-tooltip-title="@lang('t_merchant.back')"></a>
                </div>
            </div>
            ...
            <div id="div_traderScrap" class="div_trader">
                ...
                <div class="content">
                    <p class="stimulus clearfix">
                        <a href="javascript:void(0);" class="tooltipHTML help rules" data-tooltip-title="@lang('t_merchant.scrap_rules')"></a>
                        @lang('t_merchant.scrap_merchant_desc')
                    </p>

                    <div class="left_box">
                        <div class="left_header"><h2>@lang('t_merchant.offer')</h2></div>
                        <div class="left_content">
                            <div class="scrap_trader_img">
                                <img src="/img/merchant/scrap_merchant.jpg" width="140" height="140" alt="@lang('t_merchant.scrap_merchant')">
                            </div>
                            <div id="js_scrapOffer" class="offer tooltip js_hideTipOnMobile" data-tooltip-title="@lang('t_merchant.offer')">
                                @php
                            ...
                            <br class="clearfloat">
                            <p class="scrap_trader_quote">@lang('t_merchant.scrap_merchant_quote')</p>

                            <div class="resourceIcon metal resource_label odd tooltipLeft js_hideTipOnMobile" data-tooltip-title="@lang('t_merchant.metal')"></div>
                            <div id="js_scrapAmountMetal" class="resource_amount odd">0</div><br class="clearfloat">

                            <div class="resourceIcon crystal resource_label even tooltipLeft js_hideTipOnMobile" data-tooltip-title="@lang('t_merchant.crystal')"></div>
                            <div id="js_scrapAmountCrystal" class="resource_amount even">0</div><br class="clearfloat">

                            <div class="resourceIcon deuterium resource_label odd tooltipLeft js_hideTipOnMobile" data-tooltip-title="@lang('t_merchant.deuterium')"></div>
                            <div id="js_scrapAmountDeuterium" class="resource_amount odd">0</div><br class="clearfloat">

                            <button id="js_scrapBargain" class="bargain">@lang('t_merchant.bargain')</button>
                            <br class="clearfloat">
                            <span class="bargain_cost">@lang('t_merchant.costs') <span class="js_bargainCost">{{ number_format($bargainCost) }}</span> @lang('t_merchant.dark_matter')</span>
                        </div>
                    ...
                    <div class="right_box">
                        <div class="right_header">
                            <h2>@lang('t_merchant.objects_to_be_scrapped')</h2>
                        </div>
                        <div class="right_content">
                            <form id="breakerForm">
                                <div class="scrap_ships selected" id="js_tabShips">@lang('t_merchant.ships')</div>
                                <div class="scrap_defense" id="js_tabDefense">@lang('t_merchant.defensive_structures')</div>
                                            ...
                                            <li class="panel">
                                                @foreach($chunk as $shipId => $shipData)
                                                    ...
                                                    <div class="item {{ $shipData['amount'] > 0 ? 'on' : 'off' }}" id="button{{ $shipId }}">
                                                        ...
                                                        <a href="javascript:void(0);" class="max tooltip js_maxShips" ref="#ship_{{ $shipId }}" data-tooltip-title="@lang('t_merchant.select_all')"></a>
                                                    </div>
                                                @endforeach
                                            </li>
                                        @endforeach
                                ...
                                <ul id="js_anythingSliderDefense" class="defenders">
                                                ...
                                                <li class="panel">
                                                    @foreach($chunk as $defenseId => $defenseData)
                                                        ...
                                                        <div class="item {{ $defenseData['amount'] > 0 ? 'on' : 'off' }}" id="button{{ $defenseId }}">
                                                            ...
                                                            <a href="javascript:void(0);" class="max tooltip js_maxShips" ref="#ship_{{ $defenseId }}" data-tooltip-title="@lang('t_merchant.select_all')"></a>
                                                        </div>
                                                    @endforeach
                                                </li>
                                            @endforeach
                                        @else
                                            <li class="panel">
                                                <div style="padding: 20px; text-align: center;">@lang('t_merchant.no_defensive_structures_available')</div>
                                            </li>
                                        @endif
                                </ul>
                                ...
                                <div class="allornonewrap fleft">
                                    <span class="send_all">
                                        <a href="javascript:void(0);" class="tooltip js_hideTipOnMobile sendAll" data-tooltip-title="@lang('t_merchant.select_all')">
                                        </a>
                                    </span>
                                    <span class="send_none">
                                        <a href="javascript:void(0);" class="tooltip js_hideTipOnMobile sendNone" data-tooltip-title="@lang('t_merchant.reset_choice')">
                                        </a>
                                    </span>
                                </div>
                                <input id="js_scrapScrapIT" class="scrap_it disabled" type="submit" value="@lang('t_merchant.scrap')">
                            </form>
                        </div>
            ...
            if (targetInput) {
                ...
                if (val > 0) {
                    ...
                    if (maxAmount < val) {
                        ...
                        var message;
                        var storageWarningTemplate = @json(__('t_merchant.error.scrap.storage_insufficient'));
                        if (maxAmount === 0) {
                            message = storageWarningTemplate.replace(':item', itemName).replace(':amount', '0');
                        } else {
                            message = storageWarningTemplate.replace(':item', itemName).replace(':amount', maxAmount.toLocaleString());
                        }
