...
@section('content')
    ...
    <div id="alliancecomponent" class="maincontent">
                ...
                <div id="inhalt">
                    ...
                    <div id="tabs">
                        <ul class="tabsbelow" id="tab-ally">
                            <li class="aktiv">
                                <a class="createNewAlliance ipiHintable" rel="{{ route('alliance.index', ['tab' => 'createNewAlliance', 'action' => 'fetchNewAlliance', 'ajax' => 1])  }}" data-ipi-hint="ipiAllianceCreate"><span>Create alliance</span></a>
                    ...
                    <div class="alliance_wrapper">
                        <div class="allianceContent"><div id="drei">
        ...
        <script type="text/javascript">
            ...
            var token = "48a6afb169781b2213a48f697cda6126";
