...
!(function (t, i) {
  ...
  function deepExtend(t, i) {
    for (var e in i)
      i[e] && i[e].constructor && i[e].constructor === Object
        ? ((t[e] = $.extend({}, t[e]) || {}), deepExtend(t[e], i[e]))
        : (t[e] = i[e]);
    ...
    Position = {
      ...
      adjustOffsetBasedOnPosition: function (t, i, e) {
        ...
        if (n === Position.getOrientation(e)) {
          if (Position.getSide(i) !== Position.getSide(e))
            s[
              {
                x: "y",
                y: "x",
      ...
      isPointWithinBoxLayout: function (t, i, e) {
        return this.isPointWithinBox(
          ...
          e.position.left,
          e.position.top,
          e.position.left + e.dimensions.width,
          e.position.top + e.dimensions.height,
        );
      },
      ...
      intersectsLine: function (t, i, e, s, o, n, r, h, a) {
        return a
          ? ((u = ((l = r - o) * (i - n) - (c = h - n) * (t - o)) / (-l * (p = s - i) + (d = e - t) * c)),
            0 <= (f = (-p * (t - o) + d * (i - n)) / (-l * p + d * c)) &&
              f <= 1 &&
              0 <= u &&
              u <= 1 && {
                x: t + u * d,
  ...
  var Bounds = {
    ...
    Mouse = {
      ...
      getPosition: function (t) {
        ...
        return {
          left: i.left - Math.round(0.5 * this._dimensions.width) + this._shift.x,
          top: i.top - Math.round(0.5 * this._dimensions.height) + this._shift.y,
        };
      },
      ...
      }),
      {
        toRGB: function (t) {
          if (/^rgba?\(/.test(t))
            return (function (t) {
              return (
                "#" + vb((t = t.match(/^rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*(\d+))?\)$/))[1]) + vb(t[2]) + vb(t[3])
              );
            })(t);
          ub[t] && (t = ub[t]);
          var i = t.replace("#", "");
          return /^(?:[0-9a-fA-F]{3}){1,2}$/.test(i)
            ? (3 == i.length && (i = i.charAt(0) + i.charAt(0) + i.charAt(1) + i.charAt(1) + i.charAt(2) + i.charAt(2)),
              "#" + i)
            : ub._default;
        },
      }),
  ...
  ((Spin.supported = Support.css.transform && Support.css.animation),
    $.extend(Spin.prototype, {
      ...
      build: function () {
        ...
        ((this.element = $("<div>").addClass("tpd-spin").css(i)),
          this.element.append((this._rotate = $("<div>").addClass("tpd-spin-rotate"))),
          this.element.css({
            "margin-left": -0.5 * i.width,
            "margin-top": -0.5 * i.height,
          }));
        ...
        for (var e = this.options.lines, s = 0; s < e; s++) {
          ...
          (this._rotate.append(
            (o = $("<div>")
              ...
              .append((n = $("<div>").addClass("tpd-spin-line")))),
          ),
            n.css({
      ...
      start: function () {
        var t = {};
        ((t[Support.css.prefixed("animation")] = "tpd-spin 1s infinite steps(" + this.options.lines + ")"),
          this._rotate.css(t));
      },
      stop: function () {
        var t = {};
  ...
  var AjaxCache =
      ...
      {
        get: function (t) {
          for (var i = null, e = 0; e < Qb.length; e++)
            Qb[e] &&
              Qb[e].url === t.url &&
              (Qb[e].type || "GET").toUpperCase() === (t.type || "GET").toUpperCase() &&
              $.param(Qb[e].data || {}) === $.param(t.data || {}) &&
              (i = Qb[e]);
      ...
      r.extend(h.prototype, {
        _add: function (t) {
          ...
          (r.each(
            ...
            r.proxy(function (t, i) {
              var e = r(),
                s = r(i);
              (e = s.is("img") ? e.add(s) : e.add(s.find("img"))).each(
                r.proxy(function (t, i) {
                  this.images.push(
                    new o(
                      i,
        ...
        abort: function () {
          ((this._progress = this._notify = this._reject = this._resolve = function () {}),
            r.each(this.images, function (t, i) {
              i.abort();
            }),
            (this.images = []));
        },
                ...
                if (this._test()) this.success();
                  ...
                  if (((this._time += this._delay), this._time >= this.options.intervals[this._ipos][0])) {
                    if (!this.options.intervals[this._ipos + 1])
                      return void ("function" == n.type(this._timeout) && this._timeout());
          ...
          n.extend(i.prototype, {
            ...
            initialize: function (t, i, e) {
              ((this.img = n(t)[0]),
                ...
                "onload" != this.options.method && this.supports.naturalWidth ? this.poll() : this.load());
            },
            poll: function () {
              this._poll = new t({
              ...
              this._loading = setTimeout(
                n.proxy(function () {
                  ...
                  (((this._onloadImage = t).onload = n.proxy(function () {
                    ...
                    (t.onerror = n.proxy(this.error, this)),
                    (t.src = this.img.src));
                }, this),
              );
            },
            ...
            stopLoading: function () {
              (this._loading && (clearTimeout(this._loading), (this._loading = null)),
                this._onloadImage &&
                  ((this._onloadImage.onload = function () {}), (this._onloadImage.onerror = function () {})));
            },
            ...
            stopWaitingForRender: function () {
              (this._renderTimeout && (clearTimeout(this._renderTimeout), (this._renderTimeout = null)),
                this._errorRenderTimeout &&
                  (clearTimeout(this._errorRenderTimeout), (this._errorRenderTimeout = null)));
            },
          }),
          i
        );
  ...
  function Uc(t) {
    ...
    var h = (h =
      (n.position && n.position.target) ||
      ("string" === $.type(n.position) && n.position) ||
      (Pc.position && Pc.position.target) ||
      ("string" === $.type(Pc.position) && Pc.position) ||
      (Oc.position && Oc.position.target) ||
      Oc.position);
    h = Sc(h);
    var a,
      d =
        (n.position && n.position.tooltip) ||
        (Pc.position && Pc.position.tooltip) ||
        (Oc.position && Oc.position.tooltip) ||
        Tooltips.Position.getInversedPosition(h);

    if (
      ((d = Sc(d)),
      n.position
        ? "string" === $.type(n.position)
          ? ((n.position = Sc(n.position)),
            (s = {
              target: n.position,
          ...
          : ((s = {
            ...
            n.position.tooltip && (s.tooltip = Sc(n.position.tooltip)),
            n.position.target && (s.target = Sc(n.position.target)))
        : (s = {
            tooltip: d,
            target: h,
          }),
      Position.isCorner(s.target) &&
        Position.getOrientation(s.target) !== Position.getOrientation(s.tooltip) &&
        (s.target = Position.inverseCornerPlane(s.target)),
      "mouse" === n.target)
    ) {
      var p = Position.getOrientation(s.target);
      s.target =
        "horizontal" === p ? s.target.replace(/(left|right)/, "middle") : s.target.replace(/(top|bottom)/, "middle");
    }
    ...
    if (
      ...
      "mouse" === n.target
        ? ((a = $.extend({}, Oc.offset)),
          $.extend(a, Tipped.Skins.reset.offset || {}),
          t.skin &&
            $.extend(a, (Tipped.Skins[t.skin] || Tipped.Skins[Tooltips.options.defaultSkin] || {}).offset || {}),
          (a = Position.adjustOffsetBasedOnPosition(Oc.offset, Oc.position, s.target, !0)),
          t.offset && (a = $.extend(a, t.offset || {})))
        : (a = {
            x: n.offset.x,
            y: n.offset.y,
          }),
      (n.offset = a),
      n.hideOn && "click-outside" === n.hideOn && ((n.hideOnClickOutside = !0), (n.hideOn = !1), (n.fadeOut = 0)),
      n.showOn)
    ) {
      var l = n.showOn;
      ("string" === $.type(l) &&
    ...
    return (
      n.inline && "string" !== $.type(n.inline) && (n.inline = !1),
      Browser.IE &&
        Browser.IE < 9 &&
        $.extend(n, {
          fadeIn: 0,
      ...
      n.spinner &&
        (Spin.supported
          ? "boolean" === $.type(n.spinner) && (n.spinner = Pc.spinner || Oc.spinner || {})
          : (n.spinner = !1)),
      n.container || (n.container = document.body),
      n.containment &&
        "string" === $.type(n.containment) &&
        (n.containment = {
          selector: n.containment,
          padding: (Pc.containment && Pc.containment.padding) || (Oc.padding && Oc.containment.padding),
        }),
      n.shadow && (n.shadow = Support.shadow),
      n
    );
  }
  ...
  ($.extend(Skin.prototype, {
    initialize: function (t) {
      ...
      this.tooltip._tooltip[(n.shadow ? "remove" : "add") + "Class"]("tpd-no-shadow")
        [(n.radius ? "remove" : "add") + "Class"]("tpd-no-radius")
        [(n.stem ? "remove" : "add") + "Class"]("tpd-no-stem");
      ...
      (this.element
                  ...
                  $("<div>")
                    ...
                    .append(
                      (e = $("<div>")
                        ...
                        .append((s = $("<div>").addClass("tpd-background-content")))),
                    ),
                ),
            )),
        )
        .append((o = $("<div>").addClass("tpd-spinner"))),
        e.css({
          width: 999,
          height: 999,
          zoom: 1,
        ...
        o.remove(),
        i.remove(),
        (this._side = Position.getSide(t.options.position.tooltip) || "top"),
        (this._vars = {}));
    },
    destroy: function () {
      this.frames &&
      ...
      this.frames ||
        ...
        this._spinner ||
          this.tooltip._tooltip.append(
            (this._spinner = $("<div>").addClass("tpd-spinner").hide().append($("<div>").addClass("tpd-spinner-spin"))),
          ));
    },
    _frame: (function () {
      var e,
        t = $("<div>")
          .addClass("tpd-frame")
          .append((e = $("<div>").addClass("tpd-backgrounds").append($("<div>").addClass("tpd-background-shadow"))))
          .append(
            $("<div>")
              .addClass("tpd-shift-stem")
              .append($("<div>").addClass("tpd-shift-stem-side tpd-shift-stem-side-before"))
              .append($("<div>").addClass("tpd-stem"))
              .append($("<div>").addClass("tpd-shift-stem-side tpd-shift-stem-side-after")),
          );
      return (
        $.each(
          "top right bottom left".split(" "),
          $.proxy(function (t, i) {
            e.append(
              $("<div>")
                .addClass("tpd-background-box tpd-background-box-" + i)
                .append(
                  $("<div>")
                    ...
                    .append(
                      $("<div>")
                        ...
                        .append($("<div>").addClass("tpd-background tpd-background-loading"))
    ...
    _getFrame: function (t) {
      ...
      (i.addClass("tpd-frame-" + t),
        i.find(".tpd-background-shadow").css({
      ...
      return (
        ...
        i.find(".tpd-shift-stem-side").css(s),
        i
      );
    },
    ...
    startLoading: function () {
      this.tooltip.supportsLoading &&
        (this.build(),
        this._spinner || this.tooltip.is("resize-to-content") || this.setDimensions(this._css.spinner.dimensions),
    ...
    updateBackground: function () {
      ...
      if (this.tooltip.title && !this.tooltip.is("loading")) {
        ...
        ((e.height -= r),
          ...
          n.restore(),
          this.element.find(".tpd-background-content").css(e).css(o),
          this.element.find(".tpd-background-loading").css({
            "background-color": this._css.backgroundColor,
          }));
      } else
        (this.element.find(".tpd-background-title, .tpd-background-content").hide(),
          this.element.find(".tpd-background").css({
            "background-color": this._css.backgroundColor,
          }));
    ...
    paint: function () {
      if (
        ...
        var t = this._vars.frames[this._side],
          i = $.extend({}, t.background.dimensions);
        (this.element.find(".tpd-background").css(i),
          ...
          this.element.add(this.frames).add(this.tooltip._tooltip).css(t.dimensions));
        var e = this._side,
          s = this._vars.frames[e],
          o = this.element.find(".tpd-frame-" + this._side),
          n = this._vars.frames[e].dimensions;
        (o.css(n),
          o.find(".tpd-backgrounds").css(
        ...
        if (this.tooltip.options.stem)
          if ((o.find(".tpd-shift-stem").css($.extend({}, s.shift.dimensions, s.shift.position)), "vertical" === r)) {
            ...
            (a
              ...
              o.find(".tpd-background-box-" + ("left" == e ? "left" : "right")).hide(),
              "right" === e
                ? o.find(".tpd-background-box-left").css({
            ...
            (a
              ...
              o.find(".tpd-background-box-" + ("top" === e ? "top" : "bottom")).hide(),
              "bottom" === e
                ? o.find(".tpd-background-box-top").css({
        ...
        this._spinner.css({
          top: l.top + this._css.border + (0.5 * c.height - 0.5 * this._css.spinner.dimensions.height),
          left: l.left + this._css.border + (0.5 * c.width - 0.5 * this._css.spinner.dimensions.width),
        });
      }
    },
    getVars: function () {
      ...
      return (
        this.tooltip.options.stem &&
          ((d = this.stem_top.getMath().dimensions.outside),
          (i = this.stem_top._css.offset),
          (p = Math.max(d.height - this._css.border, 0))),
        (a.stemDimensions = d),
        (a.stemOffset = i),
        $.each(
          "top right bottom left".split(" "),
          $.proxy(function (t, i) {
            ...
            switch (
              (((a.frames[i] = n).dimensions[e ? "width" : "height"] += p),
              ("top" !== i && "left" !== i) || (n.background.position[i] += p),
              $.extend(n, {
                shift: {
                  position: {
                    top: 0,
    ...
    getConnectionLayout: function (t, i) {
      ...
      if ("horizontal" == s) {
        ...
        this.tooltip.options.stem &&
          ((u = f.shift.dimensions.width) - h < 2 * r && (r = Math.floor(0.5 * (u - h)) || 0), (a = o + r + 0.5 * h));
        var m = u - 2 * r,
          g = r;
        ...
        switch ((v = Position.split(t))[2]) {
          ...
          case "middle":
            ((g += Math.round(0.5 * m - 0.5 * h)),
              (p.left = g - r),
              (p.right = g - r),
              (l.left = c.left = Math.round(0.5 * f.dimensions.width)));
            break;
        ...
        ("bottom" === v[1] && ((l.top += f.dimensions.height), (c.top += f.dimensions.height)),
          $.extend(d.stem, {
            position: {
              left: g,
            },
        ...
        this.tooltip.options.stem &&
          ((b = f.shift.dimensions.height) - h < 2 * r && (r = Math.floor(0.5 * (b - h)) || 0), (a = o + r + 0.5 * h));
        ...
        switch ((v = Position.split(t))[2]) {
          ...
          case "middle":
            ((x += Math.round(0.5 * _ - 0.5 * h)),
              (p.up = x - r),
              (p.down = x - r),
              (l.top = c.top = Math.round(0.5 * f.dimensions.height)));
            break;
        ...
        ("right" === v[1] && ((l.left += f.dimensions.width), (c.left += f.dimensions.width)),
          $.extend(d.stem, {
            position: {
              top: x,
            },
    ...
    setStemShift: function (t, i) {
      ...
      if (
        ...
        e.shift.y !== i.y ||
        !s ||
        e.dimensions.width !== s.width ||
        e.dimensions.height !== s.height
      ) {
        this._shift = {
          stemPosition: t,
          shift: i,
        ...
        (i &&
          0 !== i[n] &&
          ((a.before[r.width] += i[n]),
          (a.position[r.left] += i[n]),
          (a.after[r.left] += i[n]),
          (a.after[r.width] -= i[n])),
          h.element.css(a.position),
          h.element.siblings(".tpd-shift-stem-side-before").css(a.before),
          h.element.siblings(".tpd-shift-stem-side-after").css(a.after));
      }
    },
  }),
    $.extend(Stem.prototype, {
      ...
      build: function () {
        ...
        var t = this._css.backgroundColor,
          ...
          e = i && i < 1;
        ((this._useTransform = e && Support.css.transform),
      ...
      buildTransform: function () {
                  ...
                  (this.transform = $("<div>")
                    ...
                    .append(
                      (this.first = $("<div>")
                        ...
                        .append((this.border = $("<div>").addClass("tpd-stem-border")))
        ...
        if (
          ...
          var o = {};
          ("top" === s ? ((o.bottom = 0), (o.top = "auto")) : "left" === s && ((o.right = 0), (o.left = "auto")),
            this.element.find(".tpd-stem-spacer").css(o));
        }
        ...
        var n = Support.css.prefixed("transform"),
          r = {
            ...
            "border-left-width": 0.5 * i.inside.width * e,
        ...
        ((alpha = -1 < h.indexOf("rgba") && parseFloat(h.replace(/^.*,(.+)\)/, "$1"))),
          alpha && alpha < 1 ? (h = (h.substring(0, h.lastIndexOf(",")) + ")").replace("rgba", "rgb")) : (alpha = 1));
        var a = {
          "background-color": "transparent",
        ...
        ((a[n] = "skew(" + t.skew + "deg) translate(" + t.border * e + "px, " + -1 * this._css.border * e + "px)"),
          this.element.find(".tpd-stem-border").css(a));
        ...
        if (
          ((d[n] =
            ...
            t.border * e +
            "px, " +
            (i.inside.height - this._css.border) * e +
            "px)"),
          this.element.find(".tpd-stem-border-corner").css(d),
      ...
      buildNoTransform: function () {
        ...
        if (
          ...
          var r = {};
          ("top" === n ? ((r.bottom = 0), (r.top = "auto")) : "left" === n && ((r.right = 0), (r.left = "auto")),
        ...
        ((h[e ? "height" : "width"] = "100%"),
          (h[e ? "width" : "height"] = this._css.border),
          (h[s ? "top" : "bottom"] = 0),
          $.extend(
            h,
            o
        ...
        var a = {
          ...
          d = 0.5 * i.inside.width + "px solid transparent",
          p = {
            "background-color": "transparent",
          };
        ...
        if (e) {
          l = {
            left: "auto",
            top: "50%",
            "margin-top": -0.5 * i.inside.width,
            "border-top": d,
            "border-bottom": d,
          };
          ($.extend(a, l),
            (a[o ? "right" : "left"] = 0),
            (a[o ? "border-left" : "border-right"] = i.inside.height + "px solid " + this._css.borderColor),
            $.extend(p, l),
            (p[o ? "border-left" : "border-right"] = i.inside.height + "px solid " + this._css.backgroundColor),
            (p[o ? "right" : "left"] = t.top),
            (p[o ? "left" : "right"] = "auto"),
            this.element
          ...
          var l = {
            "margin-left": -0.5 * i.inside.width,
            "border-left": d,
            "border-right": d,
          };
          ($.extend(a, l),
            (a[s ? "border-top" : "border-bottom"] = i.inside.height + "px solid " + this._css.borderColor),
            $.extend(p, l),
            (p[s ? "border-top" : "border-bottom"] = i.inside.height + "px solid " + this._css.backgroundColor),
            (p[s ? "bottom" : "top"] = t.top),
            (p[s ? "top" : "bottom"] = "auto"),
            this.element
              .find(".tpd-stem-border-center-offset")
              .css({
        ...
        (this.element.find(".tpd-stem-border-center").css(a),
          this.element.find(".tpd-stem-border-corner").css({
            "background-color": this._css.borderColor,
          }),
          this.element.find(".tpd-stem-triangle").css(p),
      ...
      getMath: function () {
        ...
        var s = degrees(Math.atan((0.5 * i) / t)),
          o = 90 - s,
          n = {
  ...
  var Tooltips = {
    ...
    _getTooltips: function (t, i) {
      ...
      if (
        (_.isElement(t)
          ? (e = $(t).data("tipped-uids")) && (s = s.concat(e))
          : $(t).each(function (t, i) {
      ...
      return (
        _.isElement(e)
          ...
          : e instanceof $
            ...
            : "string" === $.type(e) &&
              $.each(this.tooltips, function (t, i) {
    ...
    clearAjaxCache: function () {
      ($.each(
        ...
        $.proxy(function (t, i) {
          i.options.ajax &&
            (i._cache && i._cache.xhr && (i._cache.xhr.abort(), (i._cache.xhr = null)),
            i.is("updated", !1),
            i.is("updating", !1),
            i.is("sanitized", !1));
        }, this),
  ...
  ((Tooltips.Position = {
    ...
    getInversedPosition: function (t) {
      ...
      return (
        "horizontal" === o
          ? (n.vertical && (e = this.inversedPosition[e]), n.horizontal && (s = this.inversedPosition[s]))
          : (n.vertical && (s = this.inversedPosition[s]), n.horizontal && (e = this.inversedPosition[e])),
        e + s
      );
    },
    ...
    $.extend(Tooltip.prototype, {
      ...
      initialize: function (element, content) {
        if (((this.element = element), this.element)) {
          ...
          (dataOptions && (options = deepExtend($.extend({}, options), eval("({" + dataOptions + "})"))),
          ...
          if (
            ...
            parentTooltipElement &&
              (parentTooltip = Tooltips.getTooltipByTooltipElement(parentTooltipElement)) &&
      ...
      remove: function () {
        ...
        if ((-1 < i && (t.splice(i, 1), $(this.element).data("tipped-uids", t)), t.length < 1)) {
          ...
          ((e = $(this.element).data(s)) &&
            ("" != !$(this.element)[0].getAttribute("title") && $(this.element).attr("title", e),
      ...
      detach: function () {
        this.options.detach &&
          !this.is("detached") &&
          (this._tooltip && this._tooltip.detach(), this.is("detached", !0));
      },
      attach: function () {
        if (this.is("detached")) {
          var t;
                            ...
                            (this._titleRelative = $("<div>")
                              ...
                              .append(
                                (this._titleRelativePadder = $("<div>")
                                  ...
                                  .append((this._title = $("<div>").addClass("tpd-title")))),
                              )),
                          )),
                      )
                      .append(
                        (this._close = $("<div>")
                          .addClass("tpd-close")
                          .append($("<div>").addClass("tpd-close-icon").html("&times;"))),
                      )),
                  )
                  .append(
                    (this._contentRelative = $("<div>")
                      ...
                      .append(
                        (this._contentRelativePadder = $("<div>")
                          ...
                          .append((this._content = $("<div>").addClass("tpd-content")))),
                      )
                      .append(
      ...
      createPreBuildObservers: function () {
          ...
          this.options.hideOn &&
            $.each(
              ...
              $.proxy(function (t, i) {
                ...
                if (e && i) {
                  var s = i;
                  Support.touch && Browser.MobileSafari && /^(target|element)/.test(t) && /mouse(leave|out)/.test(s)
                    ? this.bind(e, s, function (t) {
                        if (
                          this._tooltipTouchEndTime &&
                          /^mouse(leave|out)$/.test(t.type) &&
                          new Date().getTime() - this._tooltipTouchEndTime < 450
                        )
                          return;
        ...
        var t = !1;
        (this.options.showOn && "mouse" === this.options.target && !this.options.fixed && (t = !0),
          t &&
            this.bind(this.element, "mousemove", function (t) {
    ...
    $.extend(Tooltip.prototype, {
      ...
      _show: function (t, i) {
        ((t = ("number" === $.type(t) ? t : this.options.fadeIn) || 0),
          (i = i || ("function" == $.type(t) && t)),
      ...
      hide: function (i, e) {
        if ((this.clearTimer("show"), this.visible() && !this.is("disabled"))) {
          ...
          (t.queue(
            ...
            "function" === $.type(this.options.afterHide) &&
              this.is("updated") &&
              t.queue(
                $.proxy(function (t) {
    ...
    $.extend(Tooltip.prototype, {
      createElementMarker: function (t) {
        !this.elementMarker &&
          ...
          ($(this.content).data("tpd-restore-inline-display", $(this.content).css("display")),
      ...
      startLoading: function () {
        this.is("loading") ||
          ...
          this.options.spinner &&
            ...
            this.is("resize-to-content") || (this.position(), this.raise(), this._show())));
      },
      stopLoading: function () {
        (this.build(),
          this.is("loading", !1),
      ...
      abortAjax: function () {
        this._cache.xhr &&
          (this._cache.xhr.abort(), (this._cache.xhr = null), this.is("updated", !1), this.is("updating", !1));
      },
      update: function (n) {
        if (!this.is("updating")) {
          (this.is("updating", !0), this.build());
          var t = this.options.inline
            ? "inline"
            : this.options.ajax
              ? "ajax"
              : _.isElement(this.content) || _.isText(this.content) || _.isDocumentFragment(this.content)
                ? "element"
                : this._fn
                  ? "function"
                  : "html";
          ...
          switch (
            ...
            case "ajax":
              ...
              var h,
                a = $.extend({}, r, e);
              if (
                (a.method && delete (a = $.extend({}, a)).method,
                $.each(
                ...
                this.options.cache && (h = AjaxCache.get(a)) && h.callbacks.success)
              )
                return void $.each(
                  h.callbacks,
                  $.proxy(function (t, i) {
      ...
      _update: function (t, i) {
        ...
        "string" === $.type(t) || _.isElement(t) || _.isText(t) || _.isDocumentFragment(t) || t instanceof $
          ? (e.content = t)
          : $.extend(e, t);
        t = e.content;
        var s = e.title,
        ...
        ((this.content = t),
          ...
          this._title.html(s && "string" === $.type(s) ? s : ""),
          this._titleWrapper[s ? "show" : "hide"](),
          this._close[(this.title || this.options.title) && o ? "show" : "hide"]());
        ...
        (this._inner_close[n ? "show" : "hide"](),
          this._tooltip[(r ? "add" : "remove") + "Class"]("tpd-has-inner-close"),
      ...
      sanitize: function (i) {
        if (!this.options.voila || this._content.find("img").length < 1)
          return (this.is("sanitized", !0), void (i && i()));
        this._cache.voila = Voila(
          ...
          $.proxy(function (t) {
            (this._markImagesAsSanitized(t.images),
              this.is("refreshed-before-sanitized")
                ? (this.is("refreshed-before-sanitized", !1), this.sanitize(i))
                : (this.is("sanitized", !0), i && i()));
          }, this),
        );
      },
      ...
      _hasAllImagesSanitized: function () {
        var s = !0;
        return (
          this._content.find("img").each(function (t, i) {
        ...
        this.visible() &&
          (this.is("sanitized")
            ? (this.is("refreshing", !0),
              ...
              !this.options.voila || this._content.find("img").length < 1 || this._hasAllImagesSanitized()
    ...
    $.extend(Tooltip.prototype, {
        ...
        if (
          ...
          if ("vertical" === Position.getOrientation(i)) {
            ...
            var l = this.getContainmentLayout(i),
              ...
              f = !1;
            if (Position.isPointWithinBoxLayout(c.x1, c.y1, l) || Position.isPointWithinBoxLayout(c.x2, c.y2, l))
              f = !0;
            else {
              $.each(
                "top right bottom left".split(" "),
            ...
            f &&
              ((d = "left" === o ? c.x1 - l.position.left : l.position.left + l.dimensions.width - c.x1), (a[o] += d));
          }
          ...
          this.options.containment &&
            (d = this.options.containment.padding) &&
            ($.each(a, function (t, i) {
              a[t] += d;
            }),
          ...
          if (this.title) {
            ...
            (this._titleWrapper.add(this._titleSpacer).css({
              ...
              this.close &&
                ...
                this._close.hide()),
              this._maxWidthPass &&
                b.width > this.options.maxWidth &&
                this._titleRelative.css({
                  width: b.width,
                }),
            ...
            ((v = {
              ...
              m.width - a.left - a.right &&
              ((v.width = m.width - a.left - a.right),
              this._titleSpacer.css({
                width: v.width,
              }),
              (v.height = Math.max(this.title ? this._titleWrapper.innerHeight() + x : 0, _.height + x))),
              (b.width = Math.max(v.width, b.width)),
              (b.height += v.height),
          ...
          if (
            ...
            b.height !==
              Math.max(this._content.innerHeight(), g.height) + (this.title ? this._titleRelative.outerHeight() : 0) &&
              b.width++,
            this.is("resize-to-content") || (b = this.skin._css.spinner.dimensions),
            this.setDimensions(b),
            (a = {
              top: r,
              right: r,
              bottom: r,
          ...
          this.options.maxWidth &&
            ...
            this.updateDimensionsToContent(t, i),
      ...
      getContainmentSpace: function (t, i) {
        ...
        return (
          o.top > r.top + h.height && (a.top -= o.top - (r.top + h.height)),
          o.top + n.height < r.top && (a.bottom -= r.top - (o.top + n.height)),
          o.left > r.left + h.width && r.left + h.width >= o.left && (a.left -= o.left - (r.left + h.width)),
          o.left + n.width < r.left && (a.right -= r.left - (o.left + n.width)),
          (this._cache.layouts.containmentSpace = a)
        );
      },
      position: function (t) {
        if (this.visible()) {
          ...
          if (this.options.containment) {
            ...
            if (
              ...
              (o = Position.flip(i)),
              (s = Position.flip(e)),
              a[Position.getSide(o)]
                ? (this.updateDimensionsToContent(o, s), (n = this.getPositionBasedOnTarget(o, s)))
                : (n.contained = !1),
              n.contained)
            )
              this.setPosition(n, s);
            else {
              r.unshift({
                position: n,
                targetPosition: o,
              ...
              var d = i,
                ...
                c =
                  (p[l[0]] === p[l[1]]
                    ? "horizontal" === Position.getOrientation(d)
                      ? "left"
                      : "top"
                    : l[p[l[0]] > p[l[1]] ? 0 : 1]) + Position.split(d)[1],
                f = Position.flip(c);
              if (
                ((o = c),
                (s = f),
                ...
                (this.updateDimensionsToContent(u.targetPosition, u.stemPosition, !0),
                  this.setPosition(u.position, u.stemPosition));
              }
            }
      ...
      getPositionBasedOnTarget: function (t, i) {
        ...
        if ("horizontal" === a) {
          switch (((e = Math.floor(0.5 * s.width)), d[2])) {
            case "left":
              n.left = e;
              break;
          ...
          switch (((e = Math.floor(0.5 * s.height)), d[2])) {
            case "top":
              n.top = e;
              break;
        ...
        if (
          ((c.top = l.top + l.connection.top),
          (c.left = l.left + l.connection.left),
          (c.top -= c.connection.top),
          (c.left -= c.connection.left),
          this.options.stem)
        ) {
          ...
          if (
            ...
            if (f <= Position.getDistance(u.connection.left, u.connection.top, u.max.left, u.max.top)) {
              var _ = {
                ...
                x = b[v] < u.stem[v] ? -1 : 1;
              ((_[v] = g * x), (_[v] += Math.floor(0.5 * f) * x), (c.left += _.left), (c.top += _.top));
            } else {
              $.extend(u, {
                center: {
                  top: Math.round(l.top + 0.5 * s.height),
                  left: Math.round(l.left + 0.5 * s.left),
                },
              });
              g =
                m[
                  Position.getDistance(u.center.left, u.center.top, u.connection.left, u.connection.top) <=
                  Position.getDistance(u.center.left, u.center.top, u.max.left, u.max.top)
                    ? "connection"
                    : "max"
                ];
              var w = {
        ...
        if (this.options.offset) {
          ...
          ((y = Position.adjustOffsetBasedOnPosition(y, this.options.position.target, t)),
            (c.top += y.y),
            (c.left += y.x));
        }
          ...
          if (0 !== D) {
            ...
            if (D * L <= E && c[z] + D >= A) ((c[z] += D), (P[M] = -1 * D), (k = !0));
              ...
              var R = (T = this.getContainment(
                ...
                F = deepExtend({}, c);
              (this.options.offset && ((F.left -= this.options.offset.x), (F.top -= this.options.offset.y)),
                ((u = {
                  stem: {
              ...
              var q = this.getTargetLayout(),
                U = ((f = r.stemDimensions.width), Math.floor(0.5 * f)),
                Q = A + I.dimensions[S ? "width" : "height"];

              if ("x" == M) {
                var V = q.position.left + U;
                (0 < R && (V += q.dimensions.width - 2 * U),
                  ((R < 0 && u.stem.left + R >= V && F.left + R >= A) ||
                    (0 < R && u.stem.left + R <= V && F.left + R <= Q)) &&
                    (F.left += R));
              } else {
                var G = q.position.top + U;
                (0 < R && (G += q.dimensions.height - 2 * U),
                  ((R < 0 && u.stem.top + R >= G && F.top + R >= A) ||
                    (0 < R && u.stem.top + R <= G && F.top + R <= Q)) &&
                    (F.top += R));
              }
      ...
      setPosition: function (t, i) {
        ...
        this.skin.setStemPosition(
          i || this.options.position.tooltip,
          t.shift || {
            x: 0,
            y: 0,
          },
      ...
      getContainment: function (t, i) {
        ...
        if (this.options.containment) {
          ...
          this.options.containment &&
            ((t.left < s.position.left || t.left + o.width > s.position.left + s.dimensions.width) &&
              ((e.horizontal = !1),
              t.left < s.position.left
                ? (e.correction.x = s.position.left - t.left)
                : (e.correction.x = s.position.left + s.dimensions.width - (t.left + o.width))),
            (t.top < s.position.top || t.top + o.height > s.position.top + s.dimensions.height) &&
              ((e.vertical = !1),
              t.top < s.position.top
                ? (e.correction.y = s.position.top - t.top)
                : (e.correction.y = s.position.top + s.dimensions.height - (t.top + o.height))));
        }
      ...
      getContainmentLayout: function (t, i) {
        ...
        o =
          n && "viewport" !== this.options.containment.selector
            ? {
                dimensions: {
                  width: $(n).innerWidth(),
        ...
        if (r && !i) {
          ...
          if ((h < 2 * r && (r = Math.max(Math.floor(0.5 * h), 0)), r))
            ((o.dimensions.width -= 2 * r),
              (o.dimensions.height -= 2 * r),
              (o.position.top += r),
              (o.position.left += r),
              "vertical" === Position.getOrientation(t)
                ? ((o.dimensions.width += r), "left" === Position.getSide(t) && (o.position.left -= r))
                : ((o.dimensions.height += r), "top" === Position.getSide(t) && (o.position.top -= r)));
        }
          ...
          (t =
            "mouse" === this.options.target
              ? this.is("api")
                ...
                : Mouse.getPosition(this._cache.event)
      ...
      getPaddingLine: function (t) {
        ...
        var o = this.getSideLine(i, e),
          n = Math.round(0.5 * i.dimensions.width);
  ...
  var Delegations = {
    ...
    add: function (t, e, s) {
      ...
      ((this._delegations[o].removeTitleHandler = $.proxy(this.removeTitle, this)),
        $(document).delegate(
          t + ":not(.tpd-delegation-uid-" + o + ")",
          "mouseenter",
          this._delegations[o].removeTitleHandler,
        ),
        (this._delegations[o].handler = n),
        $(document).delegate(t + ":not(.tpd-delegation-uid-" + o + ")", i.showOn.element, n));
    },
    ...
    remove: function (e) {
      $.each(
        ...
        $.proxy(function (t, i) {
          i.selector === e &&
            ($(document)
              .undelegate(e + ":not(.tpd-delegation-uid-" + t + ")", "mouseenter", i.removeTitleHandler)
              .undelegate(e + ":not(.tpd-delegation-uid-" + t + ")", i.options.showOn.element, i.handler),
    ...
    removeAll: function () {
      $.each(
        ...
        $.proxy(function (t, i) {
          ($(document)
            .undelegate(i.selector + ":not(.tpd-delegation-uid-" + t + ")", "mouseenter", i.removeTitleHandler)
            .undelegate(i.selector + ":not(.tpd-delegation-uid-" + t + ")", i.options.showOn.element, i.handler),
            delete this._delegations[t]);
        }, this),
      );
    },
  ...
  return (
    $.extend(Collection.prototype, {
      ...
      refresh: function (t) {
        return (
          $.each(this._tooltips, function (t, i) {
