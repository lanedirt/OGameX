...
(function ($) {
  ...
  var methods = {
    ...
    detach: function () {
      ...
      form
        .find("[" + options.validateAttribute + "*=validate][type=checkbox],[class*=validate][type=radio]")
        .off("click", methods._onFieldEvent); // unbind form.submit
    ...
    _required: function (field, rules, i, options, condRequired) {
      switch (field.prop("type")) {
        ...
        default:
          ...
          if (
            !field_val ||
            (dv_placeholder && field_val == dv_placeholder) //|| ( placeholder    && field_val == placeholder    )
          ) {
        ...
        if (options.prettySelect) {
          if (
            ...
            var prettyOverrideClass = $(
              "#" + field.attr("id").substr(options.usePrefix.length).substring(options.useSuffix.length),
    ...
    _saveOptions: function (form, options) {
      ...
      else $.error("jQuery.validationEngine rules are not loaded, plz add localization files to the page"); // --- Internals DO NOT TOUCH or OVERLOAD ---
