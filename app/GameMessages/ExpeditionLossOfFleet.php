...
class ExpeditionLossOfFleet extends ExpeditionGameMessage
{
    /**
     * The base key for the message.
     * @var string
     */
    protected static string $baseKey = 'expedition_loss_of_fleet';
     ...
     * - t_messages.expedition_loss_of_fleet.body.1
     * - t_messages.expedition_loss_of_fleet.body.2
     *
