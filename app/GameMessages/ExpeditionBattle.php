...
class ExpeditionBattle extends ExpeditionGameMessage
{
    /**
     * The base key for the message.
     * @var string
     */
    protected static string $baseKey = 'expedition_battle';
     ...
     * - t_messages.expedition_battle.body.1
     * - t_messages.expedition_battle.body.2
     *
