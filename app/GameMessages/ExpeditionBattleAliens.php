...
class ExpeditionBattleAliens extends ExpeditionGameMessage
{
    /**
     * The base key for the message.
     * @var string
     */
    protected static string $baseKey = 'expedition_battle_aliens';
     ...
     * - t_messages.expedition_battle_aliens.body.1
     * - t_messages.expedition_battle_aliens.body.2
     * - ...
     * - t_messages.expedition_battle_aliens.body.7
     *
