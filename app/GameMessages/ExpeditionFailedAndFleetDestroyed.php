...
class ExpeditionFailedAndFleetDestroyed extends ExpeditionGameMessage
{
    /**
     * The base key for the message.
     * @var string
     */
    protected static string $baseKey = 'expedition_failed_and_fleet_destroyed';
     ...
     * - t_messages.expedition_failed_and_fleet_destroyed.body.1
     * - t_messages.expedition_failed_and_fleet_destroyed.body.2
     *
