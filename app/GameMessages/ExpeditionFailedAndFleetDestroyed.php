...
class ExpeditionFailedAndFleetDestroyed extends GameMessage
{
    /**
     ...
     * - t_messages.expedition_failure_and_fleet_destroyed.body.1
     * - t_messages.expedition_failure_and_fleet_destroyed.body.2
     *
     ...
     * @var string
     */
    private static string $baseKey = 'expedition_failed_and_fleet_destroyed';
