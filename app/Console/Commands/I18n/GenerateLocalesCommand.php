...
#[Description('Generate per-language Laravel lang files for every OGame locale, mirroring the reference English structure and resolving leaves through the master dictionary.')]
#[Signature('i18n:generate-locales
