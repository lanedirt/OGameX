...
#[Description('Build the master OGame translation dictionary (storage/i18n/master_dictionary.php) from the official CANONICAL JSON scrape.')]
#[Signature('i18n:build-dictionary
