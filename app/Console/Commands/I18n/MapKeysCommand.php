...
#[Description('Map every Laravel translation key in resources/lang/<lang>/*.php to the OGame master dictionary, producing mapped.json plus reports for unmapped (custom-fork) keys.')]
#[Signature('i18n:map-keys
